...
#                 (${INSTALL_PREFIX}/share/${PACKAGE_NAME})
# PLUGIN_PATH   - path to application plugins, e.g.:
#                 (${INSTALL_PREFIX}/share/${PACKAGE_NAME}/plugins)
...
# RUNTIME_PATH  - path to run-time variable files, e.g.:
...
macro(definePaths PROJECT_NAME)
    ...
    if (CMAKE_BUILD_TYPE MATCHES Debug AND NOT DEFINED CMAKE_INSTALL_RPATH)
    ...
    if (NOT DEFINED PLUGIN_PATH)
        set(PLUGIN_PATH "${SHARED_PREFIX}/plugins")
    endif()

    if (NOT DEFINED TRANSLATION_PATH)
        set(TRANSLATION_PATH "${SHARED_PREFIX}/translations")
    endif()

    if (NOT DEFINED HELP_PATH)
        set(HELP_PATH "${SHARED_PREFIX}/doc")
    endif()

    if (NOT DEFINED ICONS_PATH)
        set(ICONS_PATH "${SHARED_PREFIX}/icons")
    endif()

    if (NOT DEFINED SOUND_PATH)
        set(SOUND_PATH "${SHARED_PREFIX}/sounds")
    endif()
    ...
    if(NOT DEFINED RUNTIME_PATH AND UNIX)
        if(FORCE_USE_INSTALL_PREFIX)
            set(RUNTIME_PATH "${INSTALL_PREFIX}/run")
        else()
            set(RUNTIME_PATH "/var/run/%1")
        endif()
    endif()

    if(NOT DEFINED TMP_PATH AND UNIX)
        if(FORCE_USE_INSTALL_PREFIX)
    ...
    doSubstitution(RUNTIME_PATH ${PROJECT_NAME} FALSE)
